...
#6069 연령대
#삼성1동
samsung1_values = df.loc[(df["ADSTRD_CD"] == 11680580) & (df["STDR_YMD_CD"].isin([20170701, 20170708, 20170715, 20170722, 20170729])), ["STDR_YMD_CD", "M6064", "M6569", "W6064", "W6569"]].values
...
#여의동
yeouido_values = df.loc[(df["ADSTRD_CD"] == 11560540) & (df["STDR_YMD_CD"].isin([20170701, 20170708, 20170715, 20170722, 20170729])), ["STDR_YMD_CD", "M6064", "M6569", "W6064", "W6569"]].values
...
#잠실6동
jamsil6_values = df.loc[(df["ADSTRD_CD"] == 11710710) & (df["STDR_YMD_CD"].isin([20170701, 20170708, 20170715, 20170722, 20170729])), ["STDR_YMD_CD", "M6064", "M6569", "W6064", "W6569"]].values
...
#잠실3동
jamsil3_values = df.loc[(df["ADSTRD_CD"] == 11710680) & (df["STDR_YMD_CD"].isin([20170701, 20170708, 20170715, 20170722, 20170729])), ["STDR_YMD_CD", "M6064", "M6569", "W6064", "W6569"]].values
...
#잠실2동
jamsil2_values = df.loc[(df["ADSTRD_CD"] == 11710670) & (df["STDR_YMD_CD"].isin([20170701, 20170708, 20170715, 20170722, 20170729])), ["STDR_YMD_CD", "M6064", "M6569", "W6064", "W6569"]].values
...
#한강로동
hangangro_values = df.loc[(df["ADSTRD_CD"] == 11170625) & (df["STDR_YMD_CD"].isin([20170701, 20170708, 20170715, 20170722, 20170729])), ["STDR_YMD_CD", "M6064", "M6569", "W6064", "W6569"]].values
...
#가락1동
garack1_values = df.loc[(df["ADSTRD_CD"] == 11710631) & (df["STDR_YMD_CD"].isin([20170701, 20170708, 20170715, 20170722, 20170729])), ["STDR_YMD_CD", "M6064", "M6569", "W6064", "W6569"]].values
...
#문정2동
moonjeong2_values = df.loc[(df["ADSTRD_CD"] == 11710642) & (df["STDR_YMD_CD"].isin([20170701, 20170708, 20170715, 20170722, 20170729])), ["STDR_YMD_CD", "M6064", "M6569", "W6064", "W6569"]].values
...
#목1동
mock1_values = df.loc[(df["ADSTRD_CD"] == 11470510) & (df["STDR_YMD_CD"].isin([20170701, 20170708, 20170715, 20170722, 20170729])), ["STDR_YMD_CD", "M6064", "M6569", "W6064", "W6569"]].values
